...
public class rock {
    ...
    public rock(int argX, int argY, int argLeftEdge, int argRightEdge, int argTopEdge, int argBottomEdge) {
        x = argX;
        y = argY;
        scale = 0.5;
        w = (int) (120*scale);
        ...
        rockImageIcon = new ImageIcon(rock.class.getResource("asyk.jpg"));
